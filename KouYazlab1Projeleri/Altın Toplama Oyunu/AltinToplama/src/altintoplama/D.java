...
public class D {
    ...
    int[][] hedefKonumD = new int[1][2];
    private int altin_miktari;
    private int hedefB_maliyet;
    private int hamle_maliyet;
    private int konumsatir = 19, konumsutun = 0;
    private int hedefnokta=0;

    public D(int altin_miktari, int hedefB_maliyet, int hamle_maliyet) {
     ...
     public void hedefBelirle(int tut[],int tut2[], int altinM[], int uzunluk, int baslangicSatir, int baslangicSutun) {
        ...
        double oran;
        int karsilastira,karsilastirb,karsilastirc;
        A ahedef=new A(200,5);
        B bhedef=new B(200,5,10);
        C chedef=new C(200,5,10);
        karsilastira=(ahedef.hedefKonumA[0][0]+ahedef.hedefKonumA[0][1])-(baslangicSatir-baslangicSutun);
        karsilastirb=(bhedef.hedefKonumB[0][0]+bhedef.hedefKonumB[0][1])-(baslangicSatir-baslangicSutun);
        karsilastirc=(chedef.hedefKonumC[0][0]+chedef.hedefKonumC[0][1])-(baslangicSatir-baslangicSutun);
        ...
        for(int i=0;i<uzunluk;i++)
        {
         ...
         hedefKonumD[0][0]=hedefsatir;
         hedefKonumD[0][1]=hedefsutun; 
    ...
    /**
     * @return the hedefKonumD
     */
    public int[][] getHedefKonumD() {
        return hedefKonumD;
    }

    /**
     * @param hedefKonumD the hedefKonumD to set
     */
    public void setHedefKonumD(int[][] hedefKonumD) {
        this.setHedefKonumD(hedefKonumD);
    }
